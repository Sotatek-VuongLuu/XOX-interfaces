...
export function inputOutputComparatorXOX<TInput extends Currency, TOutput extends Currency>(
...
export function tradeComparatorXOX<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(
  a: TradeXOX<TInput, TOutput, TTradeType>,
  b: TradeXOX<TInput, TOutput, TTradeType>
) {
...
export interface BestTradeOptionsXOX {
 ...
 */
export class TradeXOX<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
  /**
  ...
  public static exactIn<TInput extends Currency, TOutput extends Currency>(
    ...
    return new TradeXOX(route, amountIn, TradeType.EXACT_INPUT)
  }
  ...
  ): TradeXOX<TInput, TOutput, TradeType.EXACT_OUTPUT> {
    return new TradeXOX(route, amountOut, TradeType.EXACT_OUTPUT)
  }
  ...
  public static bestTradeExactIn<TInput extends Currency, TOutput extends Currency>(
    ...
    currencyOut: TOutput,
    { maxNumResults = 3, maxHops = 3 }: BestTradeOptionsXOX = {},
    // used in recursion.
    currentPairs: Pair[] = [],
  ...
  public static bestTradeExactOut<TInput extends Currency, TOutput extends Currency>(
    ...
    bestTrades: TradeXOX<TInput, TOutput, TradeType.EXACT_OUTPUT>[] = []
  ): TradeXOX<TInput, TOutput, TradeType.EXACT_OUTPUT>[] {
    invariant(pairs.length > 0, 'PAIRS')
    invariant(maxHops > 0, 'MAX_HOPS')
