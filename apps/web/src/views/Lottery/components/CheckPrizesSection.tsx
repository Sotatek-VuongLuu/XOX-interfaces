...
const CheckPrizesSection = () => {
  ...
  const getBody = () => {
    if (!account) {
      return (
        <Flex alignItems="center" justifyContent="center">
          {/* <TicketImage src={`/image-removed/lottery/ticket-l.png`} alt="lottery ticket" /> */}
          ...
          {/* <TicketImage src="/image-removed/lottery/ticket-r.png" alt="lottery ticket" /> */}
        </Flex>
      )
    }
    if (hasCheckedForRewards && !hasRewardsToClaim) {
      return (
        <Flex alignItems="center" justifyContent="center">
          {/* <TornTicketImage src="/image-removed/lottery/torn-ticket-l.png" alt="torn lottery ticket" /> */}
          ...
          {/* <TornTicketImage src="/image-removed/lottery/torn-ticket-r.png" alt="torn lottery ticket" /> */}
        </Flex>
      )
    }
    if (hasCheckedForRewards && hasRewardsToClaim) {
