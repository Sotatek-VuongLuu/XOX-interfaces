        ...
        <Grid item xs={12} md={7} className="second-box">
          <RightContent data-aos="fade-left">
            ...
            <Paragraph style={{ margin: '24px 0' }}>
              {t(
                'Designed to be the staking substitute to our governance token XOX, preventing Supply Inflation & Selling Pressure XOXS is the result of months studding how staking works, chart behavior to high APYs followed by high selling pressure from stakers and Passive Income strategies generated by implementing Stable Coins Like USDT, USDC ... Some Facts About XOXS:',
              )}
            </Paragraph>
