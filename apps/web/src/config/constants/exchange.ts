...
export const XOX_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.GOERLI]: '0x0e3FA7D925eeE7C361aBafFba280c0b376644327',
  [ChainId.BSC]: '',
...
export const USD_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.RINKEBY]: '',
  [ChainId.GOERLI]: '0x74905dfad4b2dEeD1b1a28a73De5c0BA3300e05d',
...
export const SUGGESTED_BASES_ID = {
  ...
  '0x74905dfad4b2dEeD1b1a28a73De5c0BA3300e05d': 3408, // USDC TESTNET
