...
export const INFO_CLIENT_ETH = 'https://api.studio.thegraph.com/query/40341/xox-subgraph/v0.0.22'
export const INFO_CLIENT_XOX_ETH = ''
export const INFO_CLIENT_XOX_GOERLI = 'https://api.studio.thegraph.com/query/40341/xox-subgraph/v0.0.22'
...
export const ENDPOINT_GRAPHQL_WITH_CHAIN = {
  ...
  [ChainId.GOERLI]: 'https://api.studio.thegraph.com/query/40341/xox-subgraph/v0.0.22',
}
