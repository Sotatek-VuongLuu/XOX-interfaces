  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/dev.xoxnet.io/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/dev.xoxnet.io/',
    },
    {
      id: 'trust',
      title: 'Trust Wallet',
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://dev.xoxnet.io/',
      downloadLink: {
