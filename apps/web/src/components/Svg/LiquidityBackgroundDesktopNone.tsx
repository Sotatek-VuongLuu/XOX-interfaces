const LiquiditybackgroundDesktopNone = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="591" height="465" viewBox="0 200 591 425" fill="none">
...
export default LiquiditybackgroundDesktopNone
