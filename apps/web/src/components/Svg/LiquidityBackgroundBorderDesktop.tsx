const LiquidityBackgroundBorderDesktop = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="559" height="613" viewBox="16 16 559 613" fill="none">
      <g filter="">
        <path
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.742708" stopColor="#B809B5" stopOpacity="0" />
        </linearGradient>
      </defs>
    </svg>
  )
...
export default LiquidityBackgroundBorderDesktop
