const LiquiditybackgroundDesktopNone2 = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="591" height="365" viewBox="0 200 591 325" fill="none">
...
export default LiquiditybackgroundDesktopNone2
