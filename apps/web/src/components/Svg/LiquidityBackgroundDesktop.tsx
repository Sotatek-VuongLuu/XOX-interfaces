const LiquidityBackgroundDesktop = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="559" height="200" viewBox="16 16 559 200" fill="none">
      <g filter="">
        <path
...
export default LiquidityBackgroundDesktop
